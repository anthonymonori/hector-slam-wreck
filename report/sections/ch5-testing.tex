...
We let the laser gather a bit of data, until there was no noticable interference from us moving around, and then we took a picture of the map that had been produced.
We took this map and compared it to the above overhead picture. First by estimating distances on the picture, then by digitally overlaying the two images.
