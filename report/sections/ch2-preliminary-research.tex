...
Simultaneous Localization and Mapping (SLAM) is a system where you take multiple measurements of a surrounding and add them all together to make a 2D or 3D map. Need to add more here
