...
%Thomas: Mil? (Also changed the things to fractions instead of 1/2, and such. Also added the degree sign instead of the writing.
...
A reference signal fed from the transmitter prior to the distance measurement and a received pulse reflected from the target.%Thomas: This sentence before this comment confuses me.
...
As you see the output shows, the address is available and the I2C connection is good. The -y 1 relates to the revision B of the Raspberry Pi board.
...
%Thomas: The seems to be referencing to the sample output here.
...
%Thomas: Is this the sample output?
