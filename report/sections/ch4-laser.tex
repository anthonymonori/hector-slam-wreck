\clearpage
\section{Laser} %TODO: ROHS complian and Class 1 laser - removing the casing can cause problems and decalssify it - ADD THIS TO IT'S OWN SECTION
...
\end{figure}
%TODO: Do we understand this figure completely? Does it make sense to keep it here?
...
A reference signal is sent from the transmitter to the receiver, prior to the first distance measurement with a received pulse reflected from the target.%TODO: Look at this sentance.
...
%Thomas: Missing a word or two in the final sentence? Not sure what to do.
%TODO: Look at this sentance
...
The laser can be interfaced through I2C (Inter-Integrated Circuit) or PWM (Pulsed Width Modulation)~\cite{lidarsum}. The default I2C address for the laser is 0x62, which we could validate by running the following command:
\lstset{language=sh}
\begin{lstlisting}
	>>	sudo i2cdetect -y 1
	>>
...
%Thomas: The seems to be referencing to the sample output here. DUH

%TODO: Maybe discuss the queue size  {http://wiki.ros.org/rospy/Overview/Publishers%20and%20Subscribers#Choosing_a_good_queue_size}
...
%asd.cpp 
%TODO: What is that comment above? Do you want to include the test code you wrote, Gustavo?
...
%TODO: I would move the source code to the Appendix and leave the sequence diagram. - Anonymous
