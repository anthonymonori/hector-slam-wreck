...
%TODO: confirm, please
%gustavo: so, I think this section is mixing the two versions of the laser that we had
% one of them was async and turned at exactly 0.208333... hz (~5sec per rotation)
% the other, current, one takes ~27s per rotation
% I might try to fix it myself once I'm done reading through
