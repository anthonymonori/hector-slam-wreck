...
\begin{table}[H]
	\begin{tabular}{ | p{4.5cm} | l | l | p{5cm} |}
		...
		Going over the budget & M & VL & \\ \hline
		Parts not arriving in time & L & VH & \\ \hline
		Short-circuiting electronics during development & VL & H & \\ \hline
		Lack of knowledge about ROS & M & H & \\ \hline
		Compatibility issues or lack of support for hardware & L & VH & \\ \hline
		Too big of a scope and too little time to complete & H & H & \\
	\hline
	\end{tabular}
