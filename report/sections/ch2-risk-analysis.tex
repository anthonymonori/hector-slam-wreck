...
\begin{table}[H]
	\begin{tabular}{ | p{4.5cm} | l | l | p{5cm} |}
		...
		Short-circuiting electronics during development & VL & H & Buy a new one or consider replacing it with similar hardware, like the Raspberry Pi with an Arduino if possible\\ \hline
